...
public class DataBase : ScriptableObject
{
    ...
    public void loadDB(){
        ...
        Item_Data_List.Add(new ItemData(0, "최대체력증가1단계", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "최대기력증가1단계", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "속도증가1단계", 1, ItemType.SPEEDUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "체력회복1단계", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "재료1", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "재료2", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
        Item_Data_List.Add(new ItemData(0, "재료3", 1, ItemType.ATKUP, Resources.Load<Sprite>("Assets/Resources/ItemIcon/0")));
